...
# Load dataset
file_path = r"C:\Users\sathi\OneDrive\Documents\AMAZONsales report.csv" 
try:
...
try:
    ...
    category_sales.plot(kind='bar', title='Highest Ordered Product', ylabel='Sales Amount', xlabel='Category')
    plt.xticks(rotation=45)
    plt.show()
